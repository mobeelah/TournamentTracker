...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    ...
    {
        public static string FullFilePath(this string fileName) //ex. filename = PrizeModels.csv
        {
            // the statement below returns this C:\data\TournamentTracker\PrizeModels.csv
        ...
        {
            //id, teamname, list of ids seperate by the pipe
            // 3, Tim's, 1|3|5
        ...
        {
            //id, TournamentName, Entry Fee, (Entered teams - id|id|id), (Prizes - id|id|id), (Rounds - id*id*id|id*id*id|id*id*id)
